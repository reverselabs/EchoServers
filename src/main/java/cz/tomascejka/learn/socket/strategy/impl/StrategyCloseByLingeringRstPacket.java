 ...
 *
 */
public class StrategyCloseByLingeringRstPacket extends ConnectionChannelSocketBase<String,String> 
{
	private static final Logger LOG = LoggerFactory.getLogger(StrategyCloseByLingeringRstPacket.class);
	private PrintWriter outputStream;
	private BufferedReader inputStream;

	public StrategyCloseByLingeringRstPacket(Configuration configuration, String logPrefix) 
	{
